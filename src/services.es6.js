  ...
  lorempixel: {
    ...
    render: function(args) {
      ...
      return (
        ...
        `${
          typeof text !== 'undefined' && typeof category !== 'undefined'
            ? '/' + text
            : ''
        }`
      );
  ...
  placecage: {
    ...
    render: function(args) {
      ...
      return (
        ...
        `${typeof format !== 'undefined' ? '/' + format : ''}` +
        `${
          typeof filter !== 'undefined' && typeof format === 'undefined'
            ? '/' + filter
            : ''
        }` +
        `/${width}/${height}`
